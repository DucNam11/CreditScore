...
def describe_dataset(source_files):
    '''
        ...
        presentation_df: pandas dataframe:
                            - a column "File name": the name of the file
                            - a column "Nb of rows": the number of rows per file
                            - a column "Nb of columns": the number of columns per file
                            - a column "Description": a brief description of the file
    '''

    print("The data is broken down into {} file(s): \n".format(len(source_files)))
    ...
    presentation_df = pd.DataFrame({'Filename':filenames,
                                    'Nb of lines':files_nb_lines,
                                    'Nb of columns':files_nb_columns})
...
def transform_data(app_df, bureau_df, bureau_balance_df,
    ...
    # Creation bureau_balance_by_client
    ...
    # Convert types from installments
